...
- [ ] Word-level highlight — highlight text in chat synchronized with TTS playback.
- [ ] Keyboard shortcut — spacebar to start/stop recording on desktop.
...
- [ ] Rename to Agent Hub — better reflects multi-agent capabilities.
...
- [ ] API reference — all MCP tool signatures, WebSocket types, HTTP endpoints.
