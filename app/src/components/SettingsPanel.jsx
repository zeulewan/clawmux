        ...
        <div className="settingsPanelBody">
          ...
          <div className="settingsSection">
            ...
            <div className="settingsRow">
              ...
              <div className="settingsSegmented">
                ...
                <button
                  ...
                  title={
                    !hasAppleSpeech
                      ? 'Not available in this browser — use Safari on iOS/macOS'
              ...
              {settings.sttProvider === 'apple' && (
                <div className="settingsNote">
                  Apple STT processes audio on-device via Safari's Web Speech API. No audio is sent to the server.
                </div>
              )}
            </div>
            ...
            <div className="settingsRow">
              ...
              <select className="settingsSelect" value={settings.voice} onChange={(e) => set('voice', e.target.value)}>
                {VOICES.map((v) => (
