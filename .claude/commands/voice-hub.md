...
2. Call `set_project_status` (from **voice-hub** server) to set your initial project context in the sidebar. If you know what project you're working on from CLAUDE.md or recent context, set it. Otherwise set project to "ready".

3. Greet the user using the greeting from CLAUDE.md in your working directory. Call `converse` (from **voice-hub** server) with that greeting message.
