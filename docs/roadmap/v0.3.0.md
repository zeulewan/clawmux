...
- [x] **Favicon and tab title** — Custom SVG mic favicon, tab title "Voice Hub".
- [x] **Human guide** — `docs/guide/overview.md` — what it is, how to use it, controls reference.
- [x] **Agent reference** — `docs/guide/agent-reference.md` — file map, code pointers, endpoints, debugging.
