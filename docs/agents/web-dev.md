...
|----------|---------------|
| [UI Behavior](../guide/ui-behavior.md) | Any new states, buttons, toggles, audio behaviors, or state transitions |
| [WebSocket Protocol](../guide/protocol.md) | Any new or changed WebSocket messages, REST endpoints, or session fields |
| [Agent Reference](../guide/agent-reference.md) | New state variables, config changes, file map changes |
